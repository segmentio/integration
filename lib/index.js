...
/**
 * Identify a group
 * https://segment.io/docs/methods/group
 *
...
Integration.prototype.group = function (group, settings, callback) {
  process.nextTick(callback);
};

/**
 * Trigger Pageview
 * https://segment.io/docs/methods/page
 *
...
Integration.prototype.page = function (page, settings, callback) {
  process.nextTick(callback);
};
