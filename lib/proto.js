...
/**
 * Locked `key`, `fn(err, unlock())`
 *
 * The method adds a lock on `key` and queues
 * all operations with the same key so they are run
 * sequentially instead of concurrently.
 *
 * The given `fn` will receive an error if any
 * and `unlock(fn)` function that unlocks the key.
 *
 * @param {String} key
 * @param {Function} fn
 * @api public
...
exports.locked = function(key, fn){
